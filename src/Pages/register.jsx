    ...
    <div className="auth-page register-page">
      ...
      <section className="auth-brand register-brand">
        ...
        <div className="auth-message register-message">
          ...
          <p>
            Create your Community Connect account and start
            bringing people together through meaningful activities,
        ...
        <div className="auth-form">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <label className="remember">
              ...
              <span>
                I agree to the Community Connect terms.
              </span>
